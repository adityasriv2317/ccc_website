...
//         <form action="">
//         <div>
//           <input type="text" className='border-white border-2 rounded-md font-bolder px-3 text-white py-2 mt-4 bg-gray-900' placeholder='First Name' /> 
//           <input className='border-white border-2 rounded-md font-bolder px-3 text-white py-2 bg-gray-900 mt-4' type="text" placeholder='Last Name'/>
//         </div>
//         </form>
//       </div>
//       <div>
