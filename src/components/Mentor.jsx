    ...
    <div className="about-page relative overflow-hidden bg-no-repeat">
      ...
      <div className="relative z-20 text-white py-auto">
        ...
        <div className="flex mx:flex-col md:flex-row md:mx-28 my-12 px-14 mx:px-16 w-full">
          ...
          {/* Right Section */}
          <div className="justify-center font-albert p-0 w-3/5 mx:w-full">
            ...
            {/* Text Content */}
            <div className="relative flex flex-col md:w-3/5 h-full font-semibold ml-[4vw] z-10">
              <div className="title w-full text-[rgb(150,198,255)] mb-6 mt-[2vw] text-[4vw] mx:text-[6vw] leading-tight">
                Faculty
                Coordinator
              </div>
              <div className="content font-medium text-justify text-[1.3vw] mx:text-[3vw] mx:ml-10">
